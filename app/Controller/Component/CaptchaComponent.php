...
class CaptchaComponent extends Component {
	...
	function validateCaptcha($model="cakecaptcha"){
		...
		if(isset($this->controller->data[$model]['captcha']) && !empty($this->controller->data[$model]['captcha'])){
			if($this->controller->Session->check("cakecaptcha.".$this->session_var)){
				if($this->controller->Session->read("cakecaptcha.".$this->session_var)==$this->controller->data[$model]['captcha']){
					$this->controller->Session->delete("cakecaptch.".$this->session_var);
					$this->controller->set('captchaerror',false);	
					return true;
				}
				else{
					#$this->controller->Session->setFlash("Wrong captcha");
					//debug($this->controller);
					$this->controller->set('captchaerror','Código inserido incorreto');	
					return false;
				}				
			}
		}
		else
		{
			if($this->controller->request->is('post')){
				$this->controller->set('captchaerror','Você deve inserir o código');	
				#$this->controller->Session->setFlash("You have not entered captcha");
				}
			else{
					$this->controller->set('captchaerror',false);
				}			
    ...
    protected function CreateImage() {
      ...
      //  $_SESSION[$this->session_var] = $text;
	   $this->controller->Session->write('cakecaptcha.'.$this->session_var,$text);
