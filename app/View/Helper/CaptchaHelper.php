...
class CaptchaHelper extends AppHelper{
	...
	public function __construct(View $view, $settings = array())
	{
		...
		if(!empty($view->viewVars['captchaerror']))  $this->captchaerror=$view->viewVars['captchaerror'];
    ...
    id="change-image">Não legível? Mude o texto.</a>
<?php
		#debug($this->viewVars);
		
		echo $this->Form->input('cakecaptcha',array('id'=>'captcha-form','name'=>'data[cakecaptcha][captcha]','label'=>'<b>Por favor insira o código acima</b>'));
