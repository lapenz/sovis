 ...
 */
	function __construct() {
		$messages = array(
			...
			'Empty' => array(
				'message' => __d('meio_upload', 'Este campo não pode ficar vazio.')
			),
			'UploadError' => array(
				'message' => __d('meio_upload', 'There were problems in uploading the file.')
			),
			'MaxSize' => array(
				'message' => __d('meio_upload', 'O tamanho máximo de arquivo foi excedido.')
			),
			'InvalidMime' => array(
				'message' => __d('meio_upload', 'Tipo de arquivo inválido.')
			),
			'InvalidExt' => array(
				'message' => __d('meio_upload', 'Extensão de arquivo inválida.')
			),
			'MinWidth' => array(
